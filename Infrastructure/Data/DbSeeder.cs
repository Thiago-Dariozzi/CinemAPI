...
public static class DbSeeder
{
    ...
    {
        // Si ya hay películas cargadas, asumimos que la base ya fue sembrada.
        ...
        var screens = screenFaker.Generate(20);
        ...
        var movies = movieFaker.Generate(30);
        ...
        var userFaker = new Faker<User>("es")
            ...
            .RuleFor(u => u.Password, f => "Test1234!")   // placeholder, sin hashear
